$.fn.extend({
	...
	_createImage : function(){
		var $banner = this,
			...
			i;
		for(i = 0; i < dataLen; i++){
			$banner.append("<a class=\"" + (i  ? "" : "current") + "\" title=" + data[i].name + " href=" + data[i].anchorHref + " style=\"background-image:url(" + data[i].imageUrl + ")\"></a>");
		}
	},
...
$(".banner").banner({
	setting : [
		{
			imageUrl:"http://img.alicdn.com/tps/TB1j6.ZKVXXXXX4XXXXXXXXXXXX-1600-470.jpg"
		},
		{
			imageUrl:"http://img.alicdn.com/tps/TB1b92pLXXXXXaYXFXXXXXXXXXX-1440-500.png"
		},
		{
			imageUrl:"http://img.alicdn.com/tps/TB1.8NQKVXXXXcEXXXXXXXXXXXX-1440-500.png"
		},
		{
			imageUrl:"http://img.alicdn.com/tps/TB16XqIKVXXXXcoXXXXXXXXXXXX-1440-500.jpg"
		},{
			imageUrl:""
		},
	],
